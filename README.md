...
<!-- 배너 이미지: 팀원이 제작한 배너를 업로드 후 아래 src 경로를 교체하세요 -->
<a href="#" target="_blank">
  <img src="https://via.placeholder.com/1200x300?text=말동무+Banner" alt="말동무 배너" width="100%"/>
</a>
...
2024년 한 해 동안 **3,924명**이 홀로 사망한 채 발견되었습니다. (전년 대비 7.2% 증가, 보건복지부 2025.11)
그러나 복지 종사자가 현장을 최초 발견한 비율은 **7.7%에 불과**하며, 절반 가까이는 임대인·경비원에 의해 **사후 발견**됩니다.
시스템이 위기를 예방하는 것이 아니라, **죽음을 수습하는 데 그치고 있습니다.**

### 📡 복지 시스템의 구조적 한계

담당 복지사 한 명이 수십 명의 독거 노인을 관리하는 구조에서, **월 1회 안부 확인이 사실상 전부**입니다.
독거노인의 우울증상 유병률은 16.1%로 노인 부부 가구(7.8%)의 두 배를 넘지만 _(보건복지부 노인실태조사 2023)_,
복지사가 정서 변화를 실시간으로 파악할 수 있는 수단이 없습니다.

효돌·효진이 등 AI 돌봄 로봇이 일부 지자체에 보급되어 있으나, **구매가 80만 원대**에 달해 저소득층에게 균등히 닿지 못합니다.
더 근본적으로는, 대화를 분석하거나 복지사가 이를 기반으로 사전 개입할 수 있는 **연동 구조 자체가 없습니다**.

### 💡 말동무의 해결책

말동무 서비스는 어르신의 일상 대화를 AI로 누적·분석해 감정 상태를 정량화하고,
복지사가 대시보드로 실시간 추적하며 위기 전에 **선제 개입**할 수 있도록 설계된
...
| 성시연 | 추후 추가 필요 | [GitHub](#) |
| 이재혁 | 추후 추가 필요 | [GitHub](#) |
| 장주희 | UI/UX · 디자인 | [@elliejang32](https://github.com/elliejang32) |
| 최희수 | 추후 추가 필요 | [GitHub](#) |
...
> 🛠️ 추후 추가 필요 — 실제 폴더 구조로 교체해 주세요.

```plaintext
maldonmu/
├── docs/
│   └── images/              # README용 스크린샷, 아키텍처 이미지
├── frontend/
│   ├── public/
│   ├── src/
...
> 🛠️ 아키텍처 다이어그램 이미지를 `docs/images/architecture.png`에 업로드 후 아래 주석을 해제해 주세요.

<!-- <p align="center">
  <img src="docs/images/architecture.png" width="700"/>
</p> -->

- Frontend: maldonmu-frontend
- Backend: maldonmu-backend
- AI: maldonmu-ai
